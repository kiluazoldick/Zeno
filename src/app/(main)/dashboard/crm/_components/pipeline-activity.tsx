  ...
  return (
    <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
      <Card className="xl:col-span-12">
        <CardHeader>
          <CardTitle>Flux des leads qualifiés</CardTitle>
          <CardAction>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
            ...
            <div className="flex flex-col gap-5 rounded-lg p-4 lg:col-span-4">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-muted-foreground text-sm">Total des leads qualifiés sur les 12 derniers mois.</p>
              </div>
              ...
              <div className="flex flex-col gap-3 rounded-lg border border-border/60 p-3">
                ...
                <div className="flex flex-col gap-1.5">
                  <div className="font-medium text-2xl tabular-nums leading-none">
                    {discoveryCallsBooked} <span className="font-normal text-muted-foreground text-sm">réunions</span>
                  </div>
                  <p className="text-muted-foreground text-sm">
                    {discoveryProgress}% des leads qualifiés ont pris un premier rendez-vous.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2 pt-0.5">
                  ...
                  <div className="flex items-center justify-between text-xs">
                    <div className="font-medium tabular-nums">{discoveryCallsBooked} réservés</div>
                    <div className="text-muted-foreground tabular-nums">{totalQualified} qualifiés</div>
                  </div>
                </div>
              </div>
            </div>
