  ...
  return (
    <section className="grid grid-cols-1 gap-4 xl:grid-cols-12">
        ...
        <CardContent>
          <div className="space-y-1">
            ...
            <div className="relative h-14">
              ...
              <div className="absolute top-2 bottom-2 left-[22%] flex w-[44%] items-center rounded-lg bg-zeno-primary px-2 text-primary-foreground shadow-sm">
                <div className="flex items-center gap-2">
                  <div className="flex size-7 items-center justify-center rounded-full bg-background text-zeno-primary">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="truncate text-[10px] text-primary-foreground/75">Suivi chantier</div>
                  </div>
                </div>
              </div>
      ...
      <Card className="xl:col-span-4">
        <CardHeader>
          <CardTitle>Objectif mensuel de devis</CardTitle>
        </CardHeader>
        <CardContent className="flex flex-col gap-1">
          <div className="flex items-end justify-between gap-3">
            <div className="font-medium text-2xl tabular-nums leading-none">
              {proposalSent} <span className="font-normal text-base text-muted-foreground">envoyés</span>
            </div>
            <div className="text-muted-foreground text-sm tabular-nums">{proposalGoal} objectif</div>
          </div>
              ...
              <div key={bar.id} className="flex flex-1 justify-center">
                <div
                  className={cn(
                    ...
                    bar.active ? "bg-zeno-primary/75" : "bg-muted-foreground/25",
                  )}
                />
              </div>
            ))}
          ...
          <p className="text-muted-foreground text-sm">
            {proposalProgressPercentage}% de l'objectif mensuel de devis atteint.
          </p>
        </CardContent>
      </Card>
    </section>
