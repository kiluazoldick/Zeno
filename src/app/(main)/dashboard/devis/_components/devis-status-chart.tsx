...
const statusData = [
  { status: "Brouillon", value: 3, fill: "var(--chart-4)" },
  { status: "Envoyé", value: 5, fill: "var(--chart-1)" },
  { status: "Accepté", value: 12, fill: "var(--chart-2)" },
  { status: "Refusé", value: 4, fill: "var(--chart-3)" },
];
...
const totalDevis = statusData.reduce((sum, item) => sum + item.value, 0);

export function DevisStatusChart() {
  return (
      ...
      <CardHeader>
        ...
        <CardAction>
          <div className="flex items-center gap-1 text-sm">
            <span className="font-medium">Total: {totalDevis}</span>
          </div>
        </CardAction>
      </CardHeader>
